    ...
    if (result.data) {
      ...
      if (!videoHistoryListStr) {
        ...
        localStorage.setItem(
          "videoHistoryList",
          JSON.stringify(videoHistoryList)
        );
      } else {
    ...
    <>
      ...
      <div>
        <div
          ...
          style={{
            backgroundImage:
              "https://assets.website-files.com/6502af467b2a8c4ee8159a5b/6502af467b2a8c4ee8159a77_Group%2047929.svg",
          }}
        >
          <div className="mx-auto w-full max-w-7xl px-5 mb-5">
            <div className="mx-auto flex max-w-6xl flex-col items-center text-center py-10">
              <p className="p-4 text-blue-200 text-xl">
                {indexLanguageText.beforeh1text}
              </p>
              <h1 className="mb-4 text-4xl font-bold md:text-6xl">
                {indexLanguageText.h1Text}
              </h1>
              <div className="mb-5 max-w-6xl lg:mb-8">
                <p className="text-[#7c8aaa] text-xl">
                  {indexLanguageText.pDescription}
                </p>
              </div>
              {/* <a
            ...
            {/* <div>
              <div
                className={
                  "w-[90%] mx-auto rounded-tl-[30px] rounded-tr-[30px] border-[12px] border-[#ffffff1f] object-fill"
                }
              >
                <form onSubmit={handleSubmit} className="relative shadow-lg">
                  ...
                  <div className="flex justify-center items-center space-x-3 px-2 py-2 bg-white text-black">
                    <span
                      className={`cursor-pointer p-2 rounded-lg mx-0.5 flex items-center mt-1 border ${
                        chooseAPI == "FakeSora"
                          ? "border-[#ffa11b]"
                          : "border-gray-200"
                      }`}
            ...
            {/* <div
              className={
                "border-[14px] border-[#ffffff1f] object-fill w-[90%] mx-auto mt-8"
              }
            >
              <div
                className={
                  "mx-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"
                }
              >
                <div className={"pb-2 border-b-2"}>
                  ...
                  >
                    {indexLanguageText.soraVideoExample}
                  </h2>
                </div>
                    ...
                    <div key={file.prompt}>
                      ...
                      <div className={"flex justify-center items-center"}>
                        <p className="pointer-events-none mt-2 block text-sm font-medium text-gray-500 w-[90%]">
                          {indexLanguageText.prompt}: {file.prompt}
                        </p>
                      </div>
                    </div>
                  ))}
            ...
            >
              <div
                className={
                  "mx-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-8"
                }
              >
                <div className={"pb-2 border-b-2"}>
                  <h2
                    className={
                      "text-white pt-4 text-4xl flex justify-center items-center"
                    }
                  >
                    {questionText.h2_1}
                  </h2>
                </div>
                <div className={"w-[96%] text-gray-200 prose mx-auto mt-4"}>
                  <p>{questionText.h2_1_p1}</p>
                  <p>{questionText.h2_1_p2}</p>
                  <p>{questionText.h2_1_p3}</p>
                  <p>
            ...
            >
              <div
                className={
                  "mx-auto  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-8 py-8"
                }
              >
                <div className={"pb-2 border-b-2"}>
                  <h2
                ...
                <div className={"w-[96%] text-gray-200 prose mx-auto mt-4"}>
                  <p>{questionText.h2_2_p1}</p>
                  <p>{questionText.h2_2_p2}</p>
                  <p>{questionText.h2_2_p3}</p>
                  <p>
